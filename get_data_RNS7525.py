...
patient_subfolder = "RNS7525"
PATH_RAW_DATA = os.path.join(PATH_RAW_EDF, f"PIT-{patient_subfolder}", "iEEG") 
#annot_file = "/mnt/Nexus2/RNS_DataBank/PITT/PIT-RNS7525/iEEG/PIT-RNS7525_PE20190611-1_EOF_SZ-NZ.txt"
#file_read = "/mnt/Nexus2/RNS_DataBank/PITT/PIT-RNS7525/iEEG/PIT-RNS7525_PE20190611-1_EOF_SZ-VK.EDF"

file_read = "/mnt/Nexus2/RNS_DataBank/PITT/PIT-RNS7525/iEEG/PIT-RNS7525_PE20190625-1_EOF_SZ-VK.EDF"
annot_file = "/mnt/Nexus2/RNS_DataBank/PITT/PIT-RNS7525/iEEG/PIT-RNS7525_PE20190625-1_EOF_SZ-VK.TXT"

file_read = "/mnt/Nexus2/RNS_DataBank/PITT/PIT-RNS7525/iEEG/PIT-RNS7525_PE20190806-1_EOF_SZ-VK.EDF"
annot_file = "/mnt/Nexus2/RNS_DataBank/PITT/PIT-RNS7525/iEEG/PIT-RNS7525_PE20190806-1_EOF_SZ-VK.TXT"

RUN = True


# get here data for the other patiets:
patient_list = ['RNS9183', 'RNS8973', 'RNS1529', 'RNS2227', 'RNS1534']
patient_list = ["RNS9183"]
...
for patient in patient_list:
    ...
    annot_files_sub = [os.path.join(PATH_RAW_DATA, f) for f in os.listdir(PATH_RAW_DATA) if "-NZ.TXT" in f]
